...
// GenerateClientCerts generates key and certificate and then set user credentials into the config file.
func GenerateClientCerts(tenant, username, email string) ([]byte, []byte, error) {
