...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TenantResourceUsed) DeepCopyInto(out *TenantResourceUsed) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TenantResourceUsed.
func (in *TenantResourceUsed) DeepCopy() *TenantResourceUsed {
	if in == nil {
		return nil
	}
	out := new(TenantResourceUsed)
	in.DeepCopyInto(out)
	return out
}
