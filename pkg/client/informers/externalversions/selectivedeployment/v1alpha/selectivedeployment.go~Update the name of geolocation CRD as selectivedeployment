...
import (
	selectivedeploymentv1alpha "headnode/pkg/apis/selectivedeployment/v1alpha"
	...
	v1alpha "headnode/pkg/client/listers/selectivedeployment/v1alpha"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgenetV1alpha().SelectiveDeployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgenetV1alpha().SelectiveDeployments(namespace).Watch(options)
			},
		},
		&selectivedeploymentv1alpha.SelectiveDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *selectiveDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&selectivedeploymentv1alpha.SelectiveDeployment{}, f.defaultInformer)
}
