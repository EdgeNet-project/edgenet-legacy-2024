...
func (g *TestGroup) Init() {
	...
	selectiveDeploymentRaw, _ := edgenetclientset.AppsV1alpha().SelectiveDeployments("").List(context.TODO(), metav1.ListOptions{})
	for _, selectiveDeploymentRow := range selectiveDeploymentRaw.Items {
		edgenetclientset.AppsV1alpha().SelectiveDeployments(selectiveDeploymentRow.GetNamespace()).Delete(context.TODO(), selectiveDeploymentRow.GetName(), metav1.DeleteOptions{})
	}
	deploymentObj := appsv1.Deployment{
...
func TestStartController(t *testing.T) {
	...
	edgenetclientset.AppsV1alpha().SelectiveDeployments("default").Create(context.TODO(), sdObj.DeepCopy(), metav1.CreateOptions{})
	time.Sleep(time.Millisecond * 500)
	sdCopy, err := edgenetclientset.AppsV1alpha().SelectiveDeployments("default").Get(context.TODO(), sdObj.GetName(), metav1.GetOptions{})
	util.OK(t, err)
	...
	edgenetclientset.AppsV1alpha().SelectiveDeployments("default").Update(context.TODO(), sdCopy.DeepCopy(), metav1.UpdateOptions{})
	time.Sleep(time.Millisecond * 500)
	sdCopy, err = edgenetclientset.AppsV1alpha().SelectiveDeployments("default").Get(context.TODO(), sdCopy.GetName(), metav1.GetOptions{})
	util.OK(t, err)
	...
	_, err = edgenetclientset.AppsV1alpha().SelectiveDeployments("default").Update(context.TODO(), sdCopy, metav1.UpdateOptions{})
	util.OK(t, err)
	time.Sleep(time.Millisecond * 500)
	sdCopy, err = edgenetclientset.AppsV1alpha().SelectiveDeployments("default").Get(context.TODO(), sdCopy.GetName(), metav1.GetOptions{})
	util.OK(t, err)
...
func TestCreate(t *testing.T) {
	...
	_, err := edgenetclientset.AppsV1alpha().SelectiveDeployments("create").Create(context.TODO(), sdObj.DeepCopy(), metav1.CreateOptions{})
	util.OK(t, err)
	time.Sleep(time.Millisecond * 500)
	for _, workload := range sdObj.Spec.Workloads.Deployment {
		log.Println(workload)
	}
	sdCopy, err := edgenetclientset.AppsV1alpha().SelectiveDeployments("create").Get(context.TODO(), sdObj.GetName(), metav1.GetOptions{})
	...
	edgenetclientset.AppsV1alpha().SelectiveDeployments("create").Create(context.TODO(), sdRepeatedObj.DeepCopy(), metav1.CreateOptions{})
	time.Sleep(time.Millisecond * 500)
	sdRepeatedCopy, err := edgenetclientset.AppsV1alpha().SelectiveDeployments("create").Get(context.TODO(), sdRepeatedObj.GetName(), metav1.GetOptions{})
	...
	edgenetclientset.AppsV1alpha().SelectiveDeployments("create").Create(context.TODO(), sdPartiallyRepeatedObj.DeepCopy(), metav1.CreateOptions{})
	time.Sleep(time.Millisecond * 500)
	sdPartialCopy, err := edgenetclientset.AppsV1alpha().SelectiveDeployments("create").Get(context.TODO(), sdPartiallyRepeatedObj.GetName(), metav1.GetOptions{})
	t.Run("status of failure", func(t *testing.T) {
		util.OK(t, err)
...
func TestUpdate(t *testing.T) {
	...
	edgenetclientset.AppsV1alpha().SelectiveDeployments("update").Create(context.TODO(), sdObj.DeepCopy(), metav1.CreateOptions{})
	time.Sleep(time.Millisecond * 2500)
	sdCopy, err := edgenetclientset.AppsV1alpha().SelectiveDeployments("update").Get(context.TODO(), sdObj.GetName(), metav1.GetOptions{})
	util.OK(t, err)
	util.Equals(t, success, sdCopy.Status.State)
	util.Equals(t, statusDict["sd-success"], sdCopy.Status.Message[0])
	util.Equals(t, "5/5", sdCopy.Status.Ready)
	...
	fr.Quantity = 1
	fr.Name = "Country"
	countryUSEU := []apps_v1alpha.Selector{us, fr}
	...
	for k, tc := range cases {
		t.Run(k, func(t *testing.T) {
			sdCopy, _ := edgenetclientset.AppsV1alpha().SelectiveDeployments("update").Get(context.TODO(), sdObj.GetName(), metav1.GetOptions{})
			sdCopy.Spec.Selector = tc.input
			edgenetclientset.AppsV1alpha().SelectiveDeployments("update").Update(context.TODO(), sdCopy, metav1.UpdateOptions{})
			time.Sleep(time.Millisecond * 500)
			sdCopy, _ = edgenetclientset.AppsV1alpha().SelectiveDeployments("update").Get(context.TODO(), sdObj.GetName(), metav1.GetOptions{})
...
func TestGetByNode(t *testing.T) {
	...
	time.Sleep(time.Millisecond * 500)
	sdCopy, err := edgenetclientset.AppsV1alpha().SelectiveDeployments("getbynode").Get(context.TODO(), sdObj.GetName(), metav1.GetOptions{})
	util.OK(t, err)
	util.Equals(t, success, sdCopy.Status.State)
	util.Equals(t, statusDict["sd-success"], sdCopy.Status.Message[0])
	util.Equals(t, "5/5", sdCopy.Status.Ready)
