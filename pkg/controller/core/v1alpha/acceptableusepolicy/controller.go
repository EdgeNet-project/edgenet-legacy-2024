...
func Start(kubernetes kubernetes.Interface, edgenet versioned.Interface) {
	...
	acceptableUsePolicyHandler := &Handler{}
	...
	informer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		...
		UpdateFunc: func(oldObj, newObj interface{}) {
			if reflect.DeepEqual(oldObj.(*corev1alpha.AcceptableUsePolicy).Status, newObj.(*corev1alpha.AcceptableUsePolicy).Status) {
	...
	controller := controller{
		...
		informer: informer,
		queue:    queue,
		handler:  acceptableUsePolicyHandler,
	}
