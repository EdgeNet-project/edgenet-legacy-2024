...
func Start(kubernetes kubernetes.Interface, edgenet versioned.Interface) {
	...
	informer := registrationinformerv1.NewEmailVerificationInformer(
		edgenetClientset,
		0,
		cache.Indexers{},
	)
	...
	informer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		...
		UpdateFunc: func(oldObj, newObj interface{}) {
			if reflect.DeepEqual(oldObj.(*registrationv1alpha.EmailVerification).Status, newObj.(*registrationv1alpha.EmailVerification).Status) {
