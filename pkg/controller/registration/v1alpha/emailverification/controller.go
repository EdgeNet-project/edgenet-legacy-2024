...
func Start(kubernetes kubernetes.Interface, edgenet versioned.Interface) {
	...
	informer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		...
		UpdateFunc: func(oldObj, newObj interface{}) {
			...
			if oldObj.(*registrationv1alpha.EmailVerification).Spec.Kind != newObj.(*registrationv1alpha.EmailVerification).Spec.Kind {
				event.updated.kind = true
			}
			if oldObj.(*registrationv1alpha.EmailVerification).Spec.Identifier != newObj.(*registrationv1alpha.EmailVerification).Spec.Identifier {
