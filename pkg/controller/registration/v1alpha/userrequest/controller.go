...
func Start(kubernetes kubernetes.Interface, edgenet versioned.Interface) {
	...
	userRequestHandler := &Handler{}
	// Create the userrequest informer which was generated by the code generator to list and watch userrequest resources
	informer := registrationinformerv1alpha.NewUserRequestInformer(
		edgenetClientset,
		0,
		cache.Indexers{},
	)
	...
	informer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc: func(obj interface{}) {
			...
			log.Infof("Add userrequest: %s", event.key)
			if err == nil {
		...
		DeleteFunc: func(obj interface{}) {
			...
			log.Infof("Delete userrequest: %s", event.key)
			if err == nil {
				queue.Add(event)
			}
		},
