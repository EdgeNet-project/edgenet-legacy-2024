...
func Start() {
	...
	// Create the login informer which was generated by the code generator to list and watch login resources
	informer := appsinformer_v1.NewLoginInformer(
		edgenetClientset,
		metav1.NamespaceAll,
		0,
		cache.Indexers{},
	...
	informer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc: func(obj interface{}) {
			...
			log.Infof("Add login: %s", event.key)
			if err == nil {
		...
		UpdateFunc: func(oldObj, newObj interface{}) {
			...
			log.Infof("Update login: %s", event.key)
			if err == nil {
				queue.Add(event)
			}
		},
		DeleteFunc: func(obj interface{}) {
			...
			log.Infof("Delete login: %s", event.key)
			if err == nil {
				queue.Add(event)
			}
		},
