...
func (c *FakeUsers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha.User, err error) {
	obj, err := c.Fake.
...
func (c *FakeUsers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha.UserList, err error) {
	obj, err := c.Fake.
...
func (c *FakeUsers) Create(ctx context.Context, user *v1alpha.User, opts v1.CreateOptions) (result *v1alpha.User, err error) {
	obj, err := c.Fake.
...
func (c *FakeUsers) Update(ctx context.Context, user *v1alpha.User, opts v1.UpdateOptions) (result *v1alpha.User, err error) {
	obj, err := c.Fake.
...
func (c *FakeUsers) UpdateStatus(ctx context.Context, user *v1alpha.User, opts v1.UpdateOptions) (*v1alpha.User, error) {
	obj, err := c.Fake.
...
func (c *FakeUsers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha.User, err error) {
	obj, err := c.Fake.
