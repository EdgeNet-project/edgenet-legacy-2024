...
func (c *teams) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha.Team, err error) {
	result = &v1alpha.Team{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("teams").
...
func (c *teams) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha.TeamList, err error) {
...
func (c *teams) Create(ctx context.Context, team *v1alpha.Team, opts v1.CreateOptions) (result *v1alpha.Team, err error) {
	result = &v1alpha.Team{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("teams").
...
func (c *teams) Update(ctx context.Context, team *v1alpha.Team, opts v1.UpdateOptions) (result *v1alpha.Team, err error) {
	result = &v1alpha.Team{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("teams").
...
func (c *teams) UpdateStatus(ctx context.Context, team *v1alpha.Team, opts v1.UpdateOptions) (result *v1alpha.Team, err error) {
	result = &v1alpha.Team{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("teams").
...
func (c *teams) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha.Team, err error) {
	result = &v1alpha.Team{}
