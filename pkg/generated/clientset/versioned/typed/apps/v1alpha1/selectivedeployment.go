...
type SelectiveDeploymentInterface interface {
	Create(ctx context.Context, selectiveDeployment *v1alpha1.SelectiveDeployment, opts v1.CreateOptions) (*v1alpha1.SelectiveDeployment, error)
	Update(ctx context.Context, selectiveDeployment *v1alpha1.SelectiveDeployment, opts v1.UpdateOptions) (*v1alpha1.SelectiveDeployment, error)
	UpdateStatus(ctx context.Context, selectiveDeployment *v1alpha1.SelectiveDeployment, opts v1.UpdateOptions) (*v1alpha1.SelectiveDeployment, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.SelectiveDeployment, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.SelectiveDeploymentList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SelectiveDeployment, err error)
...
func newSelectiveDeployments(c *AppsV1alpha1Client, namespace string) *selectiveDeployments {
...
func (c *selectiveDeployments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SelectiveDeployment, err error) {
	result = &v1alpha1.SelectiveDeployment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *selectiveDeployments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SelectiveDeploymentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SelectiveDeploymentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("selectivedeployments").
...
func (c *selectiveDeployments) Create(ctx context.Context, selectiveDeployment *v1alpha1.SelectiveDeployment, opts v1.CreateOptions) (result *v1alpha1.SelectiveDeployment, err error) {
	result = &v1alpha1.SelectiveDeployment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("selectivedeployments").
...
func (c *selectiveDeployments) Update(ctx context.Context, selectiveDeployment *v1alpha1.SelectiveDeployment, opts v1.UpdateOptions) (result *v1alpha1.SelectiveDeployment, err error) {
	result = &v1alpha1.SelectiveDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("selectivedeployments").
...
func (c *selectiveDeployments) UpdateStatus(ctx context.Context, selectiveDeployment *v1alpha1.SelectiveDeployment, opts v1.UpdateOptions) (result *v1alpha1.SelectiveDeployment, err error) {
	result = &v1alpha1.SelectiveDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("selectivedeployments").
...
func (c *selectiveDeployments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SelectiveDeployment, err error) {
	result = &v1alpha1.SelectiveDeployment{}
