...
var nodecontributionsResource = schema.GroupVersionResource{Group: "core.edgenet.io", Version: "v1alpha", Resource: "nodecontributions"}

var nodecontributionsKind = schema.GroupVersionKind{Group: "core.edgenet.io", Version: "v1alpha", Kind: "NodeContribution"}
...
func (c *FakeNodeContributions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha.NodeContribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(nodecontributionsResource, name), &v1alpha.NodeContribution{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeNodeContributions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha.NodeContributionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(nodecontributionsResource, nodecontributionsKind, opts), &v1alpha.NodeContributionList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeNodeContributions) Create(ctx context.Context, nodeContribution *v1alpha.NodeContribution, opts v1.CreateOptions) (result *v1alpha.NodeContribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(nodecontributionsResource, nodeContribution), &v1alpha.NodeContribution{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.NodeContribution), err
...
func (c *FakeNodeContributions) Update(ctx context.Context, nodeContribution *v1alpha.NodeContribution, opts v1.UpdateOptions) (result *v1alpha.NodeContribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(nodecontributionsResource, nodeContribution), &v1alpha.NodeContribution{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.NodeContribution), err
...
func (c *FakeNodeContributions) UpdateStatus(ctx context.Context, nodeContribution *v1alpha.NodeContribution, opts v1.UpdateOptions) (*v1alpha.NodeContribution, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(nodecontributionsResource, "status", nodeContribution), &v1alpha.NodeContribution{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.NodeContribution), err
...
func (c *FakeNodeContributions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(nodecontributionsResource, name), &v1alpha.NodeContribution{})
	return err
}
...
func (c *FakeNodeContributions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha.NodeContribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(nodecontributionsResource, name, pt, data, subresources...), &v1alpha.NodeContribution{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.NodeContribution), err
