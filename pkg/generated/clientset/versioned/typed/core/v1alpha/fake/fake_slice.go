...
var slicesResource = schema.GroupVersionResource{Group: "core.edgenet.io", Version: "v1alpha", Resource: "slices"}

var slicesKind = schema.GroupVersionKind{Group: "core.edgenet.io", Version: "v1alpha", Kind: "Slice"}
...
func (c *FakeSlices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha.Slice, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(slicesResource, name), &v1alpha.Slice{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSlices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha.SliceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(slicesResource, slicesKind, opts), &v1alpha.SliceList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSlices) Create(ctx context.Context, slice *v1alpha.Slice, opts v1.CreateOptions) (result *v1alpha.Slice, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(slicesResource, slice), &v1alpha.Slice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.Slice), err
...
func (c *FakeSlices) Update(ctx context.Context, slice *v1alpha.Slice, opts v1.UpdateOptions) (result *v1alpha.Slice, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(slicesResource, slice), &v1alpha.Slice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.Slice), err
...
func (c *FakeSlices) UpdateStatus(ctx context.Context, slice *v1alpha.Slice, opts v1.UpdateOptions) (*v1alpha.Slice, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(slicesResource, "status", slice), &v1alpha.Slice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.Slice), err
...
func (c *FakeSlices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(slicesResource, name), &v1alpha.Slice{})
	return err
}
...
func (c *FakeSlices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha.Slice, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(slicesResource, name, pt, data, subresources...), &v1alpha.Slice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.Slice), err
