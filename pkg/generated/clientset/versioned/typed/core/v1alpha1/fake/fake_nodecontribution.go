...
var nodecontributionsResource = schema.GroupVersionResource{Group: "core.edgenet.io", Version: "v1alpha1", Resource: "nodecontributions"}

var nodecontributionsKind = schema.GroupVersionKind{Group: "core.edgenet.io", Version: "v1alpha1", Kind: "NodeContribution"}
...
func (c *FakeNodeContributions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NodeContribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(nodecontributionsResource, name), &v1alpha1.NodeContribution{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.NodeContribution), err
}

// List takes label and field selectors, and returns the list of NodeContributions that match those selectors.
func (c *FakeNodeContributions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NodeContributionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(nodecontributionsResource, nodecontributionsKind, opts), &v1alpha1.NodeContributionList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.NodeContributionList{ListMeta: obj.(*v1alpha1.NodeContributionList).ListMeta}
	for _, item := range obj.(*v1alpha1.NodeContributionList).Items {
...
func (c *FakeNodeContributions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(nodecontributionsResource, opts))
}
...
func (c *FakeNodeContributions) Create(ctx context.Context, nodeContribution *v1alpha1.NodeContribution, opts v1.CreateOptions) (result *v1alpha1.NodeContribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(nodecontributionsResource, nodeContribution), &v1alpha1.NodeContribution{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.NodeContribution), err
...
func (c *FakeNodeContributions) Update(ctx context.Context, nodeContribution *v1alpha1.NodeContribution, opts v1.UpdateOptions) (result *v1alpha1.NodeContribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(nodecontributionsResource, nodeContribution), &v1alpha1.NodeContribution{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.NodeContribution), err
...
func (c *FakeNodeContributions) UpdateStatus(ctx context.Context, nodeContribution *v1alpha1.NodeContribution, opts v1.UpdateOptions) (*v1alpha1.NodeContribution, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(nodecontributionsResource, "status", nodeContribution), &v1alpha1.NodeContribution{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.NodeContribution), err
...
func (c *FakeNodeContributions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(nodecontributionsResource, name), &v1alpha1.NodeContribution{})
	return err
}
...
func (c *FakeNodeContributions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(nodecontributionsResource, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.NodeContributionList{})
	return err
}
...
func (c *FakeNodeContributions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NodeContribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(nodecontributionsResource, name, pt, data, subresources...), &v1alpha1.NodeContribution{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.NodeContribution), err
