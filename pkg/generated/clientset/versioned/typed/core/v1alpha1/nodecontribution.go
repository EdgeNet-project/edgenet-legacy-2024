...
func newNodeContributions(c *CoreV1alpha1Client) *nodeContributions {
...
func (c *nodeContributions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NodeContribution, err error) {
	result = &v1alpha1.NodeContribution{}
	err = c.client.Get().
...
func (c *nodeContributions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NodeContributionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NodeContributionList{}
	err = c.client.Get().
		Resource("nodecontributions").
...
func (c *nodeContributions) Create(ctx context.Context, nodeContribution *v1alpha1.NodeContribution, opts v1.CreateOptions) (result *v1alpha1.NodeContribution, err error) {
	result = &v1alpha1.NodeContribution{}
	err = c.client.Post().
		Resource("nodecontributions").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *nodeContributions) Update(ctx context.Context, nodeContribution *v1alpha1.NodeContribution, opts v1.UpdateOptions) (result *v1alpha1.NodeContribution, err error) {
	result = &v1alpha1.NodeContribution{}
	err = c.client.Put().
		Resource("nodecontributions").
...
func (c *nodeContributions) UpdateStatus(ctx context.Context, nodeContribution *v1alpha1.NodeContribution, opts v1.UpdateOptions) (result *v1alpha1.NodeContribution, err error) {
	result = &v1alpha1.NodeContribution{}
	err = c.client.Put().
		Resource("nodecontributions").
		Name(nodeContribution.Name).
...
func (c *nodeContributions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NodeContribution, err error) {
	result = &v1alpha1.NodeContribution{}
