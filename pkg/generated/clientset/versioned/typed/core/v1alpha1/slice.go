...
func newSlices(c *CoreV1alpha1Client) *slices {
	return &slices{
		client: c.RESTClient(),
	}
}
...
func (c *slices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Slice, err error) {
	result = &v1alpha1.Slice{}
	err = c.client.Get().
		Resource("slices").
		Name(name).
...
func (c *slices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SliceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SliceList{}
	err = c.client.Get().
		Resource("slices").
...
func (c *slices) Create(ctx context.Context, slice *v1alpha1.Slice, opts v1.CreateOptions) (result *v1alpha1.Slice, err error) {
	result = &v1alpha1.Slice{}
	err = c.client.Post().
		Resource("slices").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *slices) Update(ctx context.Context, slice *v1alpha1.Slice, opts v1.UpdateOptions) (result *v1alpha1.Slice, err error) {
	result = &v1alpha1.Slice{}
	err = c.client.Put().
		Resource("slices").
		Name(slice.Name).
...
func (c *slices) UpdateStatus(ctx context.Context, slice *v1alpha1.Slice, opts v1.UpdateOptions) (result *v1alpha1.Slice, err error) {
	result = &v1alpha1.Slice{}
	err = c.client.Put().
		Resource("slices").
		Name(slice.Name).
...
func (c *slices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Slice, err error) {
	result = &v1alpha1.Slice{}
