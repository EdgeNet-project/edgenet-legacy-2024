...
type ClusterRoleRequestInterface interface {
	Create(ctx context.Context, clusterRoleRequest *v1alpha.ClusterRoleRequest, opts v1.CreateOptions) (*v1alpha.ClusterRoleRequest, error)
	Update(ctx context.Context, clusterRoleRequest *v1alpha.ClusterRoleRequest, opts v1.UpdateOptions) (*v1alpha.ClusterRoleRequest, error)
	UpdateStatus(ctx context.Context, clusterRoleRequest *v1alpha.ClusterRoleRequest, opts v1.UpdateOptions) (*v1alpha.ClusterRoleRequest, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha.ClusterRoleRequest, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha.ClusterRoleRequestList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha.ClusterRoleRequest, err error)
...
func newClusterRoleRequests(c *RegistrationV1alphaClient) *clusterRoleRequests {
...
func (c *clusterRoleRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha.ClusterRoleRequest, err error) {
	result = &v1alpha.ClusterRoleRequest{}
	err = c.client.Get().
...
func (c *clusterRoleRequests) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha.ClusterRoleRequestList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha.ClusterRoleRequestList{}
	err = c.client.Get().
		Resource("clusterrolerequests").
...
func (c *clusterRoleRequests) Create(ctx context.Context, clusterRoleRequest *v1alpha.ClusterRoleRequest, opts v1.CreateOptions) (result *v1alpha.ClusterRoleRequest, err error) {
	result = &v1alpha.ClusterRoleRequest{}
	err = c.client.Post().
		Resource("clusterrolerequests").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterRoleRequests) Update(ctx context.Context, clusterRoleRequest *v1alpha.ClusterRoleRequest, opts v1.UpdateOptions) (result *v1alpha.ClusterRoleRequest, err error) {
	result = &v1alpha.ClusterRoleRequest{}
	err = c.client.Put().
		Resource("clusterrolerequests").
...
func (c *clusterRoleRequests) UpdateStatus(ctx context.Context, clusterRoleRequest *v1alpha.ClusterRoleRequest, opts v1.UpdateOptions) (result *v1alpha.ClusterRoleRequest, err error) {
	result = &v1alpha.ClusterRoleRequest{}
	err = c.client.Put().
		Resource("clusterrolerequests").
		Name(clusterRoleRequest.Name).
...
func (c *clusterRoleRequests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha.ClusterRoleRequest, err error) {
	result = &v1alpha.ClusterRoleRequest{}
