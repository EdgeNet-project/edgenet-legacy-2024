...
func (c *FakeTenantRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha.TenantRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(tenantrequestsResource, name), &v1alpha.TenantRequest{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeTenantRequests) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha.TenantRequestList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(tenantrequestsResource, tenantrequestsKind, opts), &v1alpha.TenantRequestList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeTenantRequests) Create(ctx context.Context, tenantRequest *v1alpha.TenantRequest, opts v1.CreateOptions) (result *v1alpha.TenantRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(tenantrequestsResource, tenantRequest), &v1alpha.TenantRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.TenantRequest), err
...
func (c *FakeTenantRequests) Update(ctx context.Context, tenantRequest *v1alpha.TenantRequest, opts v1.UpdateOptions) (result *v1alpha.TenantRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(tenantrequestsResource, tenantRequest), &v1alpha.TenantRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.TenantRequest), err
...
func (c *FakeTenantRequests) UpdateStatus(ctx context.Context, tenantRequest *v1alpha.TenantRequest, opts v1.UpdateOptions) (*v1alpha.TenantRequest, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(tenantrequestsResource, "status", tenantRequest), &v1alpha.TenantRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.TenantRequest), err
...
func (c *FakeTenantRequests) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(tenantrequestsResource, name), &v1alpha.TenantRequest{})
	return err
}
...
func (c *FakeTenantRequests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha.TenantRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(tenantrequestsResource, name, pt, data, subresources...), &v1alpha.TenantRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha.TenantRequest), err
