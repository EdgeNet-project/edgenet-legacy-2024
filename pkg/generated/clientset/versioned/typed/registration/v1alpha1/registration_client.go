...
func (c *RegistrationV1alpha1Client) ClusterRoleRequests() ClusterRoleRequestInterface {
...
func (c *RegistrationV1alpha1Client) TenantRequests() TenantRequestInterface {
...
// NewForConfigAndClient creates a new RegistrationV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*RegistrationV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &RegistrationV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new RegistrationV1alpha1Client for the given config and
...
func New(c rest.Interface) *RegistrationV1alpha1Client {
	return &RegistrationV1alpha1Client{c}
}
