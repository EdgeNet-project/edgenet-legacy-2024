...
func newRoleRequests(c *RegistrationV1alpha1Client, namespace string) *roleRequests {
	return &roleRequests{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *roleRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RoleRequest, err error) {
	result = &v1alpha1.RoleRequest{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *roleRequests) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RoleRequestList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RoleRequestList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rolerequests").
...
func (c *roleRequests) Create(ctx context.Context, roleRequest *v1alpha1.RoleRequest, opts v1.CreateOptions) (result *v1alpha1.RoleRequest, err error) {
	result = &v1alpha1.RoleRequest{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rolerequests").
...
func (c *roleRequests) Update(ctx context.Context, roleRequest *v1alpha1.RoleRequest, opts v1.UpdateOptions) (result *v1alpha1.RoleRequest, err error) {
	result = &v1alpha1.RoleRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rolerequests").
...
func (c *roleRequests) UpdateStatus(ctx context.Context, roleRequest *v1alpha1.RoleRequest, opts v1.UpdateOptions) (result *v1alpha1.RoleRequest, err error) {
	result = &v1alpha1.RoleRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rolerequests").
...
func (c *roleRequests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RoleRequest, err error) {
	result = &v1alpha1.RoleRequest{}
