	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1alpha().Users(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1alpha().Users(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1alpha.User{},
		resyncPeriod,
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1alpha.User{}, f.defaultInformer)
}

func (f *userInformer) Lister() v1alpha.UserLister {
	return v1alpha.NewUserLister(f.Informer().GetIndexer())
}
