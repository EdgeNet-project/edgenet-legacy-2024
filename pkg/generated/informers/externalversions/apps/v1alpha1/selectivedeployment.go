...
import (
	...
	v1alpha1 "github.com/EdgeNet-project/edgenet/pkg/generated/listers/apps/v1alpha1"
...
type SelectiveDeploymentInformer interface {
	...
	Lister() v1alpha1.SelectiveDeploymentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1alpha1().SelectiveDeployments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1alpha1().SelectiveDeployments(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1alpha1.SelectiveDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *selectiveDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1alpha1.SelectiveDeployment{}, f.defaultInformer)
}

func (f *selectiveDeploymentInformer) Lister() v1alpha1.SelectiveDeploymentLister {
	return v1alpha1.NewSelectiveDeploymentLister(f.Informer().GetIndexer())
}
