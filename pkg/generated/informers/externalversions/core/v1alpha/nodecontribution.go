	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha().NodeContributions().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha().NodeContributions().Watch(context.TODO(), options)
			},
		},
		&corev1alpha.NodeContribution{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeContributionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha.NodeContribution{}, f.defaultInformer)
}
