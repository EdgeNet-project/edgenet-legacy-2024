...
type SliceClaimInformer interface {
	...
	Lister() v1alpha.SliceClaimLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha().SliceClaims(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha().SliceClaims(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1alpha.SliceClaim{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sliceClaimInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha.SliceClaim{}, f.defaultInformer)
}

func (f *sliceClaimInformer) Lister() v1alpha.SliceClaimLister {
	return v1alpha.NewSliceClaimLister(f.Informer().GetIndexer())
}
