...
type SubNamespaceInformer interface {
	...
	Lister() v1alpha.SubNamespaceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha().SubNamespaces(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha().SubNamespaces(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1alpha.SubNamespace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *subNamespaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha.SubNamespace{}, f.defaultInformer)
}

func (f *subNamespaceInformer) Lister() v1alpha.SubNamespaceLister {
	return v1alpha.NewSubNamespaceLister(f.Informer().GetIndexer())
}
