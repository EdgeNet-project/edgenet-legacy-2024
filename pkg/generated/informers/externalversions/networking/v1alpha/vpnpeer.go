...
import (
	...
	v1alpha "github.com/EdgeNet-project/edgenet/pkg/generated/listers/networking/v1alpha"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1alpha().VPNPeers().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1alpha().VPNPeers().Watch(context.TODO(), options)
			},
		},
		&networkingv1alpha.VPNPeer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vPNPeerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1alpha.VPNPeer{}, f.defaultInformer)
}

func (f *vPNPeerInformer) Lister() v1alpha.VPNPeerLister {
	return v1alpha.NewVPNPeerLister(f.Informer().GetIndexer())
}
