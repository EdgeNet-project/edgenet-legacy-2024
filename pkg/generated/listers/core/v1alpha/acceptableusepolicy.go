...
type AcceptableUsePolicyLister interface {
	...
	// Get retrieves the AcceptableUsePolicy from the index for a given name.
	// Objects returned here must be treated as read-only.
...
// Get retrieves the AcceptableUsePolicy from the index for a given name.
func (s *acceptableUsePolicyLister) Get(name string) (*v1alpha.AcceptableUsePolicy, error) {
