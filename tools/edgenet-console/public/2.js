...
/***/ "./resources/js/modules/k8s/list/index.js":
/*!************************************************!*\
  !*** ./resources/js/modules/k8s/list/index.js ***!
  \************************************************/
...
var Component = function Component(_ref) {
  ...
  var ListComponent = react__WEBPACK_IMPORTED_MODULE_0___default.a.lazy(function () {
    return __webpack_require__("./resources/js/resources lazy recursive ^\\.\\/.*\\/List$")("./" + resource.name + "/List")["catch"](function (err) {
      return {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_K8s__WEBPACK_IMPORTED_MODULE_1__["K8s"], {
    api: resource.api,
    currentId: null
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_List__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ListComponent, {
    resource: resource
  })));
};
...
/***/ "./resources/js/resources lazy recursive ^\\.\\/.*\\/List$":
/*!*********************************************************************!*\
  !*** ./resources/js/resources lazy ^\.\/.*\/List$ namespace object ***!
  \*********************************************************************/
...
webpackAsyncContext.id = "./resources/js/resources lazy recursive ^\\.\\/.*\\/List$";
